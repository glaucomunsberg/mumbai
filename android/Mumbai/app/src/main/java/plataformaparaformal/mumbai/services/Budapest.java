...
public class Budapest implements Serializable {
    ...
    public void loadDataFromFile(Budapest budapest){
        ...
        this.equipmentMobilities        = budapest.equipmentMobilities;
        this.equipmentInstalations      = budapest.equipmentInstalations;
        this.equipmentScale             = budapest.equipmentScale;
        this.positionBodies             = budapest.positionBodies;
        this.numberBodies               = budapest.numberBodies;
        this.positionBodies             = budapest.positionBodies;
